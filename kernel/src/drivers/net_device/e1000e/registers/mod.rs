...
pub(super) struct E1000eRegisters {
    ...
    #[reg(RW)]
    pub icr: InterruptMask,
    #[reg(RW)]
    pub itr: ITR,
    #[reg(WO)]
    pub ics: InterruptMask,
    reserved_ims: u32,
    #[reg(RW)]
    pub ims: InterruptMask,
    reserved_imc: u32,
    #[reg(WO)]
    pub imc: InterruptMask,
    #[reg(RW)]
    pub eiac: EIAC,
    #[reg(RW)]
    pub iam: IAM,
    ...
    #[reg(RW)]
    pub extcnf_ctrl: EXTCNF_CTRL,
    reserved_extcnf_size: u32,
    #[reg(RW)]
    pub extcnf_size: EXTCNF_SIZE,
    reserved_pba: [u8; 0xF4],
    #[reg(RW)]
    pub pba: PBA,
    reserved_eemngctl: [u8; 12],
    #[reg(RO)]
    pub eemngctl: EEMNGCTL,
    #[reg(RO)]
    pub eemngdata: EEMNGDATA,
    #[reg(RO)]
    pub flmngctl: FLMNGCTL,
    #[reg(RO)]
    pub flmngdata: FLMNGDATA,
    #[reg(RO)]
    pub flmngcnt: FLMNGCNT,
    reserved_flasht: u32,
    #[reg(RW)]
    pub flasht: FLASHT,
    #[reg(RW)]
    ...
    #[reg(RW)]
    pub rx_descriptor_queue_info: ReceiveDescriptorQueueInfo,
    #[reg(RW)]
    pub rdtr: RDTR,
    reserved_rxdctl: u32,
    #[reg(RW)]
    ...
    #[reg(RW)]
    pub tx_descriptor_queue_info: TransmitDescriptorQueueInfo,
...
const _: () = {
    assert!(
        offset_of!(E1000eRegisters, fcrtv) == 0x5f40,
        "E1000eRegs.fcrtv offset is wrong!"
    );
};
