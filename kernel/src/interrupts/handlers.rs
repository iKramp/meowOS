...
pub extern "C" fn breakpoint(proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    printlnc!(level:warn,
        (0, 255, 255),
...
//gpf
pub extern "C" fn general_protection_fault(proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
...
pub extern "C" fn other_legacy_interrupt(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
...
pub extern "C" fn other_apic_interrupt(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    apic_eoi();
    InterruptReturnType::Normal
}

pub extern "C" fn apic_timer_tick(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    apic_eoi();
    InterruptReturnType::Normal
}

pub extern "C" fn legacy_timer_tick(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    // just to resume from hlt
    legacy_eoi();
    InterruptReturnType::Normal
}

pub extern "C" fn apic_error(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    let lapic_registers = unsafe { LAPIC_REGISTERS.assume_init_mut() };
...
pub extern "C" fn spurious_interrupt(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    apic_eoi();
    InterruptReturnType::Normal
}

pub extern "C" fn legacy_keyboard_interrupt(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    ps2::handle_ps2_keyboard_interrupt();
    legacy_eoi();
    InterruptReturnType::Normal
}

pub extern "C" fn apic_keyboard_interrupt(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    ps2::handle_ps2_keyboard_interrupt();
    apic_eoi();
    InterruptReturnType::Normal
}

pub extern "C" fn ps2_mouse_interrupt(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    apic_eoi();
    InterruptReturnType::Normal
}

pub extern "C" fn fpu_interrupt(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    apic_eoi();
    InterruptReturnType::Normal
}

pub extern "C" fn primary_ata_hard_disk(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
    apic_eoi();
    InterruptReturnType::Normal
}

pub extern "C" fn first_context_switch(_proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
...
pub extern "C" fn inter_processor_interrupt(proc_data: &mut InterruptProcessorState) -> InterruptReturnType {
